...
<ParamField query="timeframe" type="string" default="90d">Time window — `7d`, `30d`, `90d`, `365d`, or `all` to search across all fan-outs ever</ParamField>
