...
<CardGroup cols={2}>
  ...
  <Card title="Website widget" icon="message" href="#use-the-website-widget">
    Best when you want to ask visitors directly on your site.
  </Card>
...
## Use the website widget

If you want to ask visitors directly on your website, embed the Attribution widget.

```html
<script src="https://app.finseo.ai/api/attribution/widget/PROJECT_ID" async></script>
```

The widget uses your project Attribution configuration, including the question text, enabled channels, style, delay, and placement.

You can also load it manually:

```html
<script
  src="https://app.finseo.ai/api/attribution/widget/PROJECT_ID"
  data-trigger="manual"
  async>
</script>

<button onclick="window.finseoAttribution.show()">
  Tell us how you found us
</button>
```

The widget posts responses to Finseo's attribution collector and stores one response per browser for the project.
