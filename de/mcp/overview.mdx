...
| `list_prompts` | Getrackte Prompts mit Metriken, Top-Wettbewerbern und Citations pro Prompt (paginiert via `offset`/`hasMore`) — liefert die Prompt-`id` für die Prompt-Drill-down-Tools |
