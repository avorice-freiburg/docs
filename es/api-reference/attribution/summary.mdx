---
title: Obtener resumen de atribución
api: GET /v1/projects/{projectId}/attribution/summary
---

Obtén datos de atribución agregados con el desglose por canal, el porcentaje de búsqueda con IA y los ingresos totales atribuidos. Úsalo para entender qué porcentaje de tus leads viene de la búsqueda con IA frente a otros canales.
