...
Recupera un único proyecto por su ID, incluida la configuración que se usa para el Tracking de visibilidad en IA.

<ParamField path="projectId" type="string" required>
  Identificador del proyecto en formato MongoDB.
</ParamField>
