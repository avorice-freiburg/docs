---
title: Récupérer un projet
api: GET /v1/projects/{projectId}
---

Récupère un projet unique par son ID, y compris les paramètres utilisés pour le Tracking de visibilité IA.

<ParamField path="projectId" type="string" required>
  Identifiant de projet au format MongoDB.
</ParamField>
