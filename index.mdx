...
<CardGroup cols={2}>
  <Card title="Tracking Prompts" icon="message" href="/getting-started/prompts">
    Add the right questions to monitor AI visibility
  </Card>
  <Card title="AI Models" icon="sparkles" href="/getting-started/models">
    Configure where Finseo runs your prompts
  </Card>
  <Card title="Bot Analytics" icon="bot" href="/bot-analytics">
    Upload server logs and monitor AI crawler access
  </Card>
  <Card title="Human Traffic" icon="users" href="/human-traffic">
    Measure visits, conversions, and revenue from AI platforms
  </Card>
  <Card title="Attribution" icon="webhook" href="/attribution">
    Send form, CRM, and order attribution into Finseo
  </Card>
  <Card title="Integrations" icon="plug" href="/integrations">
    Connect forms, CRMs, analytics, and attribution sources
  </Card>
  <Card title="Search Console" icon="search" href="/search-console">
    Extract real user prompts from Google and Bing query data
  </Card>
  <Card title="Products and AI Shopping" icon="shopping-bag" href="/products">
    Analyze mentioned products, shopping listings, stores, and attributes
  </Card>
  <Card title="Sentiment" icon="heart" href="/sentiment">
