---
title: Ottieni un progetto
api: GET /v1/projects/{projectId}
---

Recupera un singolo progetto tramite ID, incluse le impostazioni usate per il Tracking della visibilità AI.

<ParamField path="projectId" type="string" required>
  Identificatore del progetto in stile MongoDB.
</ParamField>
